...
<head>
    ...
    <link rel="stylesheet" href="__STATIC__/admin/user/css/bootstrap.min.css">
    <link rel="stylesheet" id="css-main" href="__STATIC__/admin/user/css/oneui.css">
    <link rel="stylesheet" id="css-main" href="__STATIC__/admin/user/css/dolphin.css">
    <!-- END Stylesheets -->
</head>
<body>
<!-- Error Content -->
