...
//                       $app_ids =urlencode($app_id);
                       ...
                       return ajax_success('数据成功返回',$app);
                   }
               }else{
