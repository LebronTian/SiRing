            ...
            if(!empty( $order_num)){
               ...
               if(!empty($data)){
                   foreach ($data as $k=>$v){
                       ...
                       $body_name ="app_id=2016112603335050&biz_content=".$app_ids."&charset=utf-8&method=alipay.trade.app.pay&sign_type=RSA2&timestamp=".$time_encode."&version=1.0";
...
//                       $app ="app_id=2016112603335050"."&biz_content=".$app_ids ;
                       ...
                       $tm ='2018-10-29+16%3A19%3A48';
                       $tms =urldecode($tm);
                       $test ="alipay_sdk=alipay-sdk-java-dynamicVersionNo&app_id=2016112603335050"."&biz_content=".$data_name;
                       /**
                        * 别人成功数据开始
                        */
